/*!
 * @brief   ASN(x) just sleeping with everything off
 *
 * Application to analyze the ASN(x) power consumption in sleeping mode.
 *
 * @file    /007-sleeping/sleeping.c
